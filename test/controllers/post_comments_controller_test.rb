...
class PostCommentsControllerTest < ActionController::TestCase
  ...
  test "should create post_comment" do
    assert_difference('PostComment.count') do
      post :create, post_comment: { comment: @post_comment.comment, email: @post_comment.email, name: @post_comment.name, post_id: @post_comment.post_id }
    end
  ...
  test "should update post_comment" do
    patch :update, id: @post_comment, post_comment: { comment: @post_comment.comment, email: @post_comment.email, name: @post_comment.name, post_id: @post_comment.post_id }
    assert_redirected_to post_comment_path(assigns(:post_comment))
  end
